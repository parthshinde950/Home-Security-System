...
label_title = tk.Label(frame1, text="Home Security System")
...
icon = icon.resize((150,150), resample=Image.LANCZOS)
...
btn1 = tk.Button(frame1, text='Night Mode', height=90, width=180, fg='green',command = find_motion, image=btn1_image, compound='left')
btn1['font'] = btn_font
...
btn_font = font.Font(size=25)
btn3 = tk.Button(frame1, text='Day Mode', height=90, width=180, fg='green', command=noise, image=btn3_image, compound='left')
btn3['font'] = btn_font
...
btn6 = tk.Button(frame1, text='Smart', height=90, width=180, fg='green', command=demo, image=btn6_image, compound='left')
btn6['font'] = btn_font
